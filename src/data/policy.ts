...
// 경기 12곳 (10.15 대책) + 2026.7.1 추가 지정(동탄·기흥·구리)
const GYEONGGI_REG = [
  '41290', // 과천
  '41210', // 광명
  ...
  '41430', // 의왕
  '41450', // 하남
  // ── 2026.6.30 발표, 7.1 효력 (국토부 보도자료: 동탄·기흥·구리 3곳 신규 지정) ──
  '41463', // 용인 기흥
  '41310', // 구리
  // 화성 동탄구는 신설 구라 LAWD 코드 확정 시 추가 (regions.ts에 화성 미등재)
]

export const CURRENT_POLICY: PolicyRule = {
  effectiveDate: '2026-07-01',
  note: '10.15 대책 골격 + 2026.7.1 추가 규제지역(동탄·기흥·구리) 반영. 기준 대출금리는 가정값(은행별 상이).',
  sources: [
